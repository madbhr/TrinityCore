                    ...
                    switch (eventId)
                    {
                        ...
                        case EVENT_TIMER:
                            if (Creature* computer = me->FindNearestCreature(NPC_COMPUTER,100.0f))
                            {
                                ...
                                {
                                    case 1:
                                        computer->AI()->Talk(SAY_9_MIN);
                                        break;
                                    case 2:
                                        computer->AI()->Talk(SAY_8_MIN);
                                        break;
                                    case 3:
                                        computer->AI()->Talk(SAY_7_MIN);
                                        break;
                                    case 4:
                                        computer->AI()->Talk(SAY_6_MIN);
                                        break;
                                    case 5:
                                        computer->AI()->Talk(SAY_5_MIN);
                                        break;
                                    case 6:
                                        computer->AI()->Talk(SAY_4_MIN);
                                        break;
                                    case 7:
                                        computer->AI()->Talk(SAY_3_MIN);
                                        break;
                                    case 8:
                                        computer->AI()->Talk(SAY_2_MIN);
                                        break;
                                    case 9:
                                        computer->AI()->Talk(SAY_1_MIN);
                                        break;
                                    default:
                                        break;
                                }
                        ...
                        case EVENT_TIMEUP:
                            if (Creature* computer = me->FindNearestCreature(NPC_COMPUTER,100.0f))
                                computer->AI()->Talk(SAY_DESTROY_MIN);
                            break;
                        case EVENT_OVERRIDE:
                            if (Creature* computer = me->FindNearestCreature(NPC_COMPUTER,100.0f))
                                computer->AI()->Talk(SAY_OVERRIDE_MIN);
                            break;
                    }
                }
            }
            ...
            void KilledUnit(Unit * /*who*/)
            {
                if (Creature* mimiron = me->FindNearestCreature(NPC_MIMIRON,100.0f))
                {
                    if (phase == PHASE_AERIAL_SOLO)
                        mimiron->AI()->Talk(SAY_AERIAL_SLAY);
                    else
                        mimiron->AI()->Talk(SAY_V07TRON_SLAY);
                }
            }
